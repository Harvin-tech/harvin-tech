...
export default function AddCourse() {
  ...
  const renderFormSection = () => {
    switch (activeTab) {
      case 0:
        return <CourseForm section="base" onUpdate={updateFormData} data={formData.base} />;
      case 1:
        return <CourseForm section="pricing" onUpdate={updateFormData} data={formData.pricing} />;
      case 2:
        return <CourseForm section="media" onUpdate={updateFormData} data={formData.media} />;
      case 3:
        return <CourseForm section="seo" onUpdate={updateFormData} data={formData.seo} />;
      case 4:
        return <CourseForm section="finish" onUpdate={updateFormData} data={formData.finish} />;
      default:
        return null;
    }
  };
