...
const WorldMap = () => {
  const LOCATION = { lat: 17.385, lng: 78.4867, city: 'Hyderabad' };
          ...
          <div className="md:col-span-4 space-y-6">
            <div className="bg-white/5 rounded-xl p-6 backdrop-blur-sm border border-white/10">
              <p className="text-xl font-semibold text-white/90 tracking-tight">
                Harvinn technologies is a premier AI-based platform dedicated to
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-white/80 hover:text-white transition-colors flex items-center gap-2">
                    ...
                    <Link href="tel:+919849541178"> +91 9849541178</Link>
                  </p>
                </div>
              </div>
            </div>
