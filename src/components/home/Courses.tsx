...
const dummyCourses = [
  ...
  },
  {
    ...
    description: "Dive deep into advanced concepts like hooks, context API, and performance optimization.",
    rating: 4.8,
    reviewsCount: 256,
  },
  {
  ...
  },
  {
    ...
    description: "Understand the principles of cloud computing and how to deploy applications on the cloud.",
    rating: 4.7,
    reviewsCount: 142,
  },
  {
    ...
    description: "Learn strategies for SEO, social media marketing, and content creation.",
    rating: 4.4,
    reviewsCount: 198,
  },
];
                  ...
                  <Card className="flex flex-col h-full group pb-3">
                    <CardContent className="flex flex-col justify-between gap-2 min-h-[385px] py-2 px-2">
                      ...
                      <div className="mt-4 flex flex-col justify-between">
                        <div className="font-semibold text-primary text-base">{course.title}</div>
